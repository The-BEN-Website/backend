...
from .views import MessageList, MessageDetail, MessageCreateview, MessageManageView, AnnouncementList, AnnouncementDetail, SongList, SongDetail, TestimonyList, TestimonyDetail
